...
write.csv2(abs_mun, "./datasus/output/obitos/final/negres_capitais_abs.csv", row.names = FALSE)
write.csv2(perc_rms, "./datasus/output/obitos/final/perc_negres_rms.csv", row.names = FALSE)
write.csv2(abs_rms, "./datasus/output/obitos/final/negres_rms_abs.csv", row.names = FALSE)
