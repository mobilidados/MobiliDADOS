...
#Organizar e colocar um relative path nesse codigo
...
infra <- oe_read(paste0("./geofabrik/",ano,"/brazil.osm.pbf"),
                 layer = "lines",
...
st_write(infra_ciclo_capitais[infra_ciclo_capitais$code_muni == i,],
         paste0("D:/Projetos/mobilidados/pnb_novo/infra_ciclo/",ano,"/infra_ciclo_",
