# Essa sequ?ncia de c?digos pressup?e um tratamento manual dos inputs utilizados
...
write.csv2(motorization_capitals_pivot_moto , "./frota/output/motorization_capitals_pivot_moto.csv", fileEncoding = "latin1", row.names = FALSE)
write.csv2(motorization_capitals_pivot_motorizado , "./frota/output/motorization_capitals_pivot_motorizado.csv", fileEncoding = "latin1", row.names = FALSE)
write.csv2(motorization_rms_pivot_moto , "./frota/output/motorization_rms_pivot_moto.csv", fileEncoding = "latin1", row.names = FALSE)
write.csv2(motorization_rms_pivot_motorizado , "./frota/output/motorization_rms_pivot_motorizado.csv", fileEncoding = "latin1", row.names = FALSE)
write.csv2(final_data, "./frota/output/final_data.csv", fileEncoding = "latin1", row.names = FALSE)
